...
def cft2dAds3MixedFluxPulsatingIntegralQuantization : String := "qft.cft.2d.ads3_mixed_flux_pulsating_integral_quantization"
...
def stringAdS3MixedFluxPulsatingIntegralQuantization : String := "string.ads3.mixed_flux_pulsating_integral_quantization"
...
def assumptionRegistry : List AssumptionEntry :=
  ...
  , ⟨AssumptionId.cft2dAds3MixedFluxPulsatingIntegralQuantization,
      "The mixed-flux AdS3 pulsating integral-quantization package (`2 ∮_0^{r0} dr (R^2/alpha') (dot r/(1+r^2)) = 2 pi n`, integer level `n`, and positive period normalization interpreted as `2pi`) is assumed in this abstraction layer."⟩

...
- `CurrentAlgebras.lean`: AdS3 `SL(2,R)` WZW/spectral-flow/representation-window/mass-shell interfaces and purely `(NS,NS)` worldsheet matter-SCFT central-charge package.

...
- `CurrentAlgebras.lean`: AdS3 `SL(2,R)` WZW/spectral-flow/representation-window/mass-shell interfaces, plus `(NS,NS)` worldsheet matter-SCFT, affine-level-shift, and spin-field/GSO constraint packages.
